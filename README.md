...
An interactive mobile app prototype showcasing a UX redesign of Immuny's allergy emergency app. Built by Kappa Theta Pi (USC) to minimize cognitive load and ensure users can navigate critical features in seconds during a high-stress allergic reaction.

**Live:** https://immuny.vercel.app
**Client:** [immuny.ai](https://www.immuny.ai)
...
Built as a KTP Spring 2026 consulting engagement focused on UX research, usability testing, and interface redesign.

| | |
|--|--|
| KTP Chapter | USC |
| Semester | Spring 2026 |
| Engagement Type | Mobile UX design, interactive prototype, usability research |
| Client | [immuny.ai](https://www.immuny.ai) |
